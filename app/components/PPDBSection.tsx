...
export default function PPDBSection() {
  return (
    <div
      className="w-full relative py-8 md:py-16 overflow-hidden bg-white"
      style={{
        backgroundImage: "repeating-linear-gradient(to bottom, #f1f5f9, #f1f5f9 1.5px, transparent 1.5px, transparent 40px)",
      }}
    >
      ...
      <div className="w-full max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="relative w-full max-w-[600px] h-[800px] mx-auto hidden md:block">
            ...
            >
              <path
                d="M 520 0 Q 485 10, 450 10 C 370 10, 150 100, 150 200 C 150 300, 440 290, 440 390 C 440 490, 140 480, 140 580 C 140 680, 280 670, 280 750"
                stroke="#93c5fd"
                strokeWidth="2.5"
                strokeDasharray="8 6"
                fill="none"
            ...
            {/* Card 1: Top-Right */}
            <div
              className="absolute w-[260px] bg-white rounded-2xl p-5 shadow-[0_4px_24px_rgba(0,0,0,0.06)] border border-slate-100 transition-all duration-300 hover:shadow-[0_8px_32px_rgba(0,0,0,0.1)] hover:scale-[1.03] z-10"
              style={{
                top: "10px",
                left: "320px",
